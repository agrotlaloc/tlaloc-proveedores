...
const navigation = [
  ...
  { name: 'Tienda', href: '#' },
  { name: 'agrotlaloc.com', href: 'https://agrotlaloc.com/' },
]
  ...
  return (
    <div className="bg-white">
        ...
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              <span className="sr-only">Tláloc</span>
              <img
                className="h-8 w-auto"
                src="https://agrotlaloc.com/upload/tlaloc-nobg.png"
                alt=""
              />
            </a>
          </div>
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-3xl py-32 sm:py-48 lg:py-200">
          ...
          <div className="text-center">
            ...
            ¡Conviértete en proveedor de Tláloc y lleva tus productos agrícolas al siguiente nivel!
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600">
            Alcanza a miles de agricultores en nuestra plataforma. ¡Únete hoy!
